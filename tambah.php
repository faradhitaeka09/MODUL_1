...
if (isset($_POST["submit"])) {
    if (tambah($_POST) > 0) {
        $message = "Data berhasil ditambahkan"; // Pesan berhasil
    } else {
        $message = "Data gagal ditambahkan"; // Pesan gagal
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Form Input Produk Tiket Bus</title>
    <style>
        body {
...
<div class="container">
    <h2>Form Input Produk Tiket Bus</h2>
